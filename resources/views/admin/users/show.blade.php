...
@section('content')
    ...
    <div class="grid gap-6 xl:grid-cols-3">
        {{-- Left: account --}}
        <div class="space-y-6">
            <form method="POST" action="{{ route('admin.users.update', $user) }}" class="dash-card space-y-4">
                @csrf
                @method('PUT')
                ...
                <button type="submit" class="ui-btn-primary w-full">Save profile</button>
            </form>
        ...
        {{-- Right: subscriptions + logs + affiliate --}}
        <div class="space-y-6 xl:col-span-2">
            <div class="dash-card">
                <h3 class="dash-card-title">Subscriptions</h3>
                ...
                @else
                    <p class="mb-4 text-sm text-ink-muted">No active subscription.</p>
                @endif

                <form method="POST" action="{{ route('admin.users.subscriptions.grant', $user) }}" class="rounded-xl border border-dashed border-line p-4">
                    @csrf
                ...
                @if ($subscriptionHistory->isNotEmpty())
                    <h4 class="mb-2 mt-6 text-xs font-bold uppercase tracking-wider text-ink-muted">History</h4>
            ...
            <div class="grid gap-6 lg:grid-cols-2">
                <div class="dash-card">
                    ...
                    <p class="mb-3 text-xs text-ink-muted">{{ $uniqueIpsWeek }} unique IPs · {{ $uniqueDevicesWeek }} devices (recent logs)</p>
                    <div class="dash-table-wrap max-h-80 overflow-y-auto">
                        <table class="dash-table text-xs">
                            ...
                            <tbody>
                                ...
                                @empty
                                    <tr><td colspan="4" class="text-center text-ink-muted">No logs yet</td></tr>
                                @endforelse
                            </tbody>
                        </table>
                    </div>
                    ...
                    <div class="dash-table-wrap">
                        <table class="dash-table text-xs">
                            ...
                            <tbody>
                                ...
                                @empty
                                    <tr><td colspan="3" class="text-center text-ink-muted">No active sessions</td></tr>
                                @endforelse
                            </tbody>
                        </table>
                    </div>
            ...
            <div class="dash-card">
                <h3 class="dash-card-title">Affiliate &amp; referrals</h3>
                ...
                @if ($referrals->isNotEmpty())
                    <h4 class="mb-2 text-xs font-bold uppercase text-ink-muted">Users referred</h4>
                    <div class="dash-table-wrap mb-4">
                        <table class="dash-table text-sm">
                ...
                @if ($commissions->isNotEmpty())
                    <h4 class="mb-2 text-xs font-bold uppercase text-ink-muted">Commissions</h4>
                    <div class="dash-table-wrap mb-4">
                        <table class="dash-table text-sm">
                ...
                @if ($payouts->isNotEmpty())
                    <h4 class="mb-2 text-xs font-bold uppercase text-ink-muted">Payout requests</h4>
                    <div class="dash-table-wrap">
                        <table class="dash-table text-sm">
